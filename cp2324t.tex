...
\\
\>[B]{}\Varid{anaRotate}\mathrel{=}\anaList{(\Varid{id}+\Varid{id}\times\Varid{rotate})\comp \Varid{outList}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{matrot}\mathrel{=}\Varid{concat}\;(\Varid{anaRotate}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pre}\mathbin{::}\Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{pre}\mathrel{=}\mathsf{conc}\comp \conj{\Varid{id}}{\Varid{filter}\;\Varid{isVowel}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{anaReverse}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
...
\\
\>[B]{}\Varid{reverseByPredicate}\;\Varid{p}\mathrel{=}\Varid{anaReverse}\;\Varid{p}\comp \Varid{pre}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{worker}{}\<[17]%
\>[17]{}\mathrel{=}\for{\Varid{loop}\;\Varid{x}}\ {\Varid{start}\;\Varid{x}}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{wrapper}\mathrel{=}\p1\comp \p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[13]{}\Conid{D}\mathbin{\$}\Varid{nub}\mathbin{\$}\map \;((\Varid{id}\times\Varid{divide})\comp \Varid{dup})\;{}\<[54]%
\>[54]{}\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{divide}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;(\Varid{n}\;\Varid{x}\;\Varid{l})\mathbin{/}\Varid{fromIntegral}\;\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{t}{}\<[12]%
\>[12]{}\mathrel{=}\length \;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mksd}\mathbin{::}\Conid{Segment}\to (\Conid{Segment},\fun{Dist}\;\Conid{Delay}){}\<[E]%
\\
