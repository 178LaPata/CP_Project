...
\begin{eqnarray*}
\start
\ensuremath{\Varid{matrot}\mathrel{=}\Varid{concat}\comp \Varid{anaRotate}}
\just\equiv{ (72); (73) }
\ensuremath{\Varid{matrot}\mathrel{=}\Varid{concat}\;(\Varid{anaRotate})}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{anaReverse}\mathrel{=}\anaList{(\Varid{id}+\Varid{ifp})\comp \Varid{outList}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{reverseByPredicate}\;\Varid{p}\mathrel{=}\Varid{anaReverse}\comp \Varid{pre}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{db}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mkdist}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{delay}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
