...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotate}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{rotate}\mathrel{=}\Varid{reverse}\comp \Varid{transpose}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{anaRotate}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{anaRotate}\mathrel{=}\anaList{(\Varid{id}+\Varid{id}\times\Varid{\Conid{Main}.rotate})\comp \Varid{outList}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{matrot}\mathrel{=}\Varid{concat}\comp \Varid{anaRotate}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isVowel}\mathrel{=}\Varid{oneOf}\;\text{\ttfamily \char34 AEIOUaeiouÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚàáâãèéêìíòóôõùúĨĩŨũẼẽ\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pre}\;{}\<[6]%
\>[6]{}\Varid{p}\mathrel{=}\mathsf{conc}\comp \conj{\Varid{id}}{\Varid{filter}\;\Varid{p}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{anaReverse}\mathbin{::}(\Varid{a2}\to \Conid{Bool})\to [\mskip1.5mu \Varid{a2}\mskip1.5mu]\to [\mskip1.5mu \Varid{a2}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{anaReverse}\;\Varid{p}\mathrel{=}\anaList{(\Varid{id}+\Varid{ifp})\comp \Varid{outList}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{5}{}\<[11]%
\>[11]{}\Varid{ifp}{}\<[16]%
\>[16]{}\mathrel{=}\mcond{\Varid{p}\comp \p1}{{}\<[36]%
\>[36]{}\conj{\Varid{last}}{\Varid{init}}\comp \p2}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
     \ensuremath{\Conid{A}}^*\ar@/_1.5pc/[rr]_{\ensuremath{\Varid{reverseByPredicate}}}\ar[r]^(0.50){\ensuremath{\Varid{pre}}} & \ensuremath{\Conid{A}}^*\ar[r]^(0.50){\ensuremath{\Varid{anaReverse}}} & \ensuremath{\Conid{A}}^*
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{reverseByPredicate}\;\Varid{p}\;\Varid{s}\mathrel{=}\Varid{anaReverse}\;\Varid{p}\mathbin{\$}\Varid{pre}\;\Varid{p}\;\Varid{s}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{start}\mathbin{::}\Conid{Num}\;\Varid{b1}\Rightarrow \Varid{b2}\to ((\Varid{b2},\Varid{b2}),\Varid{b1}){}\<[E]%
\\
\>[B]{}\Varid{start}\;\Varid{x}\mathrel{=}((\Varid{x},\Varid{x}),\mathrm{0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\clearpage
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{den}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{den}\;\Varid{i}{}\<[8]%
\>[8]{}\mathrel{=}(\mathrm{2}\mathbin{*}\Varid{i}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\mathbin{*}\Varid{i}\mathbin{+}\mathrm{3}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{num}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{num}\;\Varid{x}{}\<[8]%
\>[8]{}\mathrel{=}\Varid{x}\mathbin{\uparrow}\mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\mathbin{::}\Conid{Fractional}\;\Varid{b}\Rightarrow \Varid{b}\to ((\Varid{b},\Varid{b}),\Varid{b})\to ((\Varid{b},\Varid{b}),\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{loop}\;{}\<[7]%
\>[7]{}\Varid{x}\;((\Varid{s},\Varid{p}),\Varid{i})\mathrel{=}((\Varid{s}\mathbin{+}\Varid{conta},\Varid{conta}),\Varid{i}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{conta}\mathrel{=}\Varid{p}\mathbin{*}{}\<[24]%
\>[24]{}(\Varid{num}\;\Varid{x}\mathbin{/}\Varid{den}\;\Varid{i}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{eqnarray*}
\xymatrix@C=7cm @R=2cm{
     \N_0 \ar[r]^{out_{\N_0}}\ar[d]_{\ensuremath{\Varid{worker}}} & 1+ \N_0\ar[d]^{id +\ensuremath{\Varid{worker}}} \\
     (\N_0 \times{\N_0}) \times{\N_0} & 1+ (\N_0 \times{\N_0}) \times{\N_0}\ar[l]^{\ensuremath{\alt{\underline{\Varid{start}}\;\Varid{x}}{\Varid{loop}\;\Varid{x}}}} 
}
\end{eqnarray*}

\begin{eqnarray*}
\start
\ensuremath{\Varid{worker}\mathrel{=}\for{\Varid{loop}\;\Varid{x}}\ {\Varid{start}\;\Varid{x}}}
\just\equiv{ Def ciclo-for }
\ensuremath{\Varid{worker}\mathrel{=}\llparenthesis\, \alt{\underline{\Varid{start}}\;\Varid{x}}{\Varid{loop}\;\Varid{x}}\,\rrparenthesis}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{snh}\mathbin{::}(\Conid{Integral}\;\Varid{a},\Conid{Fractional}\;\Varid{b})\Rightarrow \Varid{b}\to \Varid{a}\to \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{snh}\;\Varid{x}\mathrel{=}\Varid{wrapper}\comp \Varid{worker}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{5}{}\<[11]%
\>[11]{}\Varid{worker}{}\<[19]%
\>[19]{}\mathrel{=}\for{\Varid{loop}\;\Varid{x}}\ {\Varid{start}\;\Varid{x}}{}\<[E]%
\\
\>[6]{}\hsindent{5}{}\<[11]%
\>[11]{}\Varid{wrapper}\mathrel{=}\p1\comp \p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lka}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow \Varid{a}\to [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu \Varid{b}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{lka}\;\Varid{k}\mathrel{=}\map \;\p2\comp \Varid{filter}\;((\equiv \Varid{k})\comp \p1){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment mkdist :: Eq a => [a] -> Dist a}{}\<[E]%
\\
\>[B]{}\Varid{mkdist}\;\Varid{l}\mathrel{=}{}\<[13]%
\>[13]{}\Conid{D}\mathbin{\$}\Varid{nub}\mathbin{\$}\map \;((\Varid{id}\times\Varid{divide})\comp \Varid{\Conid{Cp}.dup})\;{}\<[57]%
\>[57]{}\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{5}{}\<[11]%
\>[11]{}\Varid{divide}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;(\Varid{n}\;\Varid{x}\;\Varid{l})\mathbin{/}\Varid{fromIntegral}\;\Varid{t}{}\<[E]%
\\
\>[6]{}\hsindent{5}{}\<[11]%
\>[11]{}\Varid{t}{}\<[14]%
\>[14]{}\mathrel{=}\length \;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{n}\;\Varid{x}\mathrel{=}\length \comp \Varid{filter}\;(\equiv \Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  mksd :: Segment -> (Segment, Dist Delay)}{}\<[E]%
\\
\>[B]{}\Varid{mksd}\mathrel{=}\conj{\Varid{id}}{\Varid{mkdist}\comp \Varid{flip}\;\Varid{lka}\;\Varid{dados}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{itemize}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment db :: [(Segment, Dist Delay)]}{}\<[E]%
\\
\>[B]{}\Varid{db}\mathrel{=}\map \;\Varid{mksd}\mathbin{\$}\Varid{nub}\mathbin{\$}\map \;\p1\;\Varid{dados}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{10}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  delay :: Segment -> Dist Delay}{}\<[E]%
\\
\>[B]{}\Varid{delay}\mathrel{=}{}\<[10]%
\>[10]{}\Varid{fj}\comp \Varid{mkf}\;\Varid{db}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fj}\mathbin{::}\Conid{Maybe}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{fj}\;(\Conid{Just}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=7cm @R=2cm{
     Segment^* \ar[r]^{out_{Listas}}\ar[d]_{\ensuremath{\Varid{somatorio}}} & 1+Segment\times{Segment^*}\ar[d]^{id +id \times{\ensuremath{\Varid{somatorio}}}} \\
     Dist Delay & 1+Segment \times{Dist Delay}\ar[l]^{\ensuremath{\alt{\underline{\Varid{instantaneous}}}{\uncurry{(\Varid{joinWith}\;(\mathbin{+})\comp \Varid{delay})}}}} 
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{somatorio}\mathbin{::}[\mskip1.5mu \Conid{Segment}\mskip1.5mu]\to \fun{Dist}\;\Conid{Delay}{}\<[E]%
\\
\>[B]{}\Varid{somatorio}\mathrel{=}\llparenthesis\, \alt{\underline{\Varid{instantaneous}}}{\uncurry{(\Varid{joinWith}\;(\mathbin{+})\comp \Varid{delay})}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  pdelay :: Stop -> Stop -> Dist Delay}{}\<[E]%
\\
\>[B]{}\Varid{pdelay}\;\Varid{a}\;\Varid{b}\mathrel{=}\Varid{somatorio}\mathbin{\$}{}\<[27]%
\>[27]{}\uncurry{\Varid{zip}}\mathbin{\$}{}\<[42]%
\>[42]{}\conj{\Varid{id}}{\Varid{tail}}\mathbin{\$}{}\<[59]%
\>[59]{}\Varid{enumFromTo}\;\Varid{a}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
