...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{den2}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{den2}\;\Varid{i}{}\<[9]%
\>[9]{}\mathrel{=}(\mathrm{2}\mathbin{*}\Varid{i}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\mathbin{*}\Varid{i}\mathbin{+}\mathrm{3}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{num2}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{num2}\;\Varid{x}{}\<[9]%
\>[9]{}\mathrel{=}\Varid{x}\mathbin{\uparrow}\mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[24]{}(\Varid{num2}\;\Varid{x}\mathbin{/}\Varid{den2}\;\Varid{i}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=7cm @R=2cm{
     ...
     (\N_0 \times{\N_0}) \times{\N_0} & 1+ (\N_0 \times{\N_0}) \times{\N_0}\ar[l]^{\ensuremath{\alt{\underline{\Varid{start}}}{\Varid{loop}}}} 
}
\end{eqnarray*}
...
\ensuremath{\Varid{worker}\mathrel{=}\llparenthesis\, \alt{\underline{\Varid{start}}}{\Varid{loop}}\,\rrparenthesis}
\end{eqnarray*}
